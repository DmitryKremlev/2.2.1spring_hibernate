...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carService.add(new Car(2107, "Lada"));
      carService.add(new Car(412, "Moskwich"));
      carService.add(new Car(1000, "Tesla"));
      carService.add(new Car(111, "Fiat"));
      ...
      System.out.println("Найти Fiat 111");
      System.out.println(userService.findUser(111, "Fiat"));
